"""Analyze the E1 (Qwen 32B chunked) merged predictions.

Thin wrapper around analyse_e0a.py — same metrics, same output format
as E0a / E0partial so the comparison table stays apples-to-apples.

Usage:
  python scripts/merge_chunked_predictions.py --dir reports/e1_qwen32b
...
DEFAULT_DIR = ROOT / "reports" / "e1_qwen32b"
...
def main():
    ...
    (args.dir / "analysis.md").write_text(
        _a.render_md(stats, title="# E1 — Qwen 2.5 32B Instruct chunked baseline analysis"))
